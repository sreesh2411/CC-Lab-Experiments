...
mysql=MySQL(app)
app.config['MYSQL_HOST']	 = 'pes1201801580.c6kybbx1skun.us-east-1.rds.amazonaws.com'
app.config['MYSQL_USER']	 = 'PES1201801580'
app.config['MYSQL_PASSWORD'] = 'sreesh123'
app.config['MYSQL_DB'] 		 = 'sreesh'
